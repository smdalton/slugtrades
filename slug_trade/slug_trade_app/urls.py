...
urlpatterns = [
    ...
    url(r'^transaction/$', views.transaction, name='view_item_details'),  # handles post requests
    url(r'^item_details/(?P<item_id>\d+)/$', views.item_details, name='view_item_details'),
    url(r'^transaction/(?P<item_id>\d+)/$', views.transaction, name='view_item_details'),
